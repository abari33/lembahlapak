...
<section class="mise_slider  <?php echo $showReverseText ? 'reverse' : 'classic' ?>" id="<?php echo esc_attr($sliderSectionID); ?>">
	<div class="flexslider ">
	  <ul class="slides">
		...
		<li>
			<div class="flexImage miseBigImage withZoom misebox" style="background-image: url(<?php echo esc_url($firstSlideImage); ?>);">
			</div>
			<div class="flexText">
				<div class="inside">
		...
		<li>
			<div class="flexImage miseBigImage withZoom misebox" style="background-image: url(<?php echo esc_url($secondSlideImage); ?>);">
			</div>
			<div class="flexText">
				<div class="inside">
		...
		<li>
			<div class="flexImage miseBigImage withZoom misebox" style="background-image: url(<?php echo esc_url($thirdSlideImage); ?>);">
			</div>
			<div class="flexText">
				<div class="inside">
