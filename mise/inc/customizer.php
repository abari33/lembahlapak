...
add_filter('wp_generate_tag_cloud', 'mise_fix_tag_cloud',10,3);
	...
	class Mise_Customize_Upgrade_Control extends WP_Customize_Control {
        public function render_content() {  ?>
			...
			<p style="text-align:center;" class="mise-custom-button">
				<a style="margin: 10px;" target="_blank" href="<?php echo esc_url(admin_url('themes.php?page=mise-welcome&tab=documentation')); ?>" class="button button-secondary">
					<?php esc_html_e('Theme Documentation', 'mise'); ?>
				</a>
				<a style="margin: 10px;" target="_blank" href="http://crestaproject.com/demo/mise/" class="button button-secondary">
